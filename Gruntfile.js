    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                ...
                src : ['build/built.js'],
                dest: '../servlets/web/script/cornerstoneWADOImageLoader.js'
            }
        },
        uglify: {
            dist: {
                files: {
                    '../servlets/web/script/cornerstoneWADOImageLoader.min.js': ['../servlets/web/script/cornerstoneWADOImageLoader.js']
                }
            },
            options: {
                banner: '/*! <%= pkg.name %> - v<%= pkg.version %> - ' +
